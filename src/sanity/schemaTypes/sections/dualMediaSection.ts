...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'image',
      description: 'Optional. Defaults to small image if not set. Maximum file size: 500KB.',
      validation: imageSizeValidation,
      hidden: ({ parent }) => parent?.mediaType1 !== 'image',
    }),
    defineField({
    ...
    defineField({
      ...
      type: 'image',
      description: 'Optional. Defaults to large image if not set. Maximum file size: 500KB.',
      validation: imageSizeValidation,
      hidden: ({ parent }) => parent?.mediaType2 !== 'image',
    }),
    defineField({
